...
3. [API Documentation](#api-documentation)
   - [GET `/leetcode`](#get-leetcode)
   - [GET `/codechef`](#get-codechef)
   - [GET `/codeforces`](#get-codeforces)
   - [GET `/contests`](#get-contests)
   - [GET `/search-contests`](#get-search-contests)
   - [GET `/upcoming-contests`](#get-upcoming-contests)
   - [GET `/update-all-contests`](#get-update-all-contests)
   - [GET `/delete`](#get-delete)
   - [GET `/update-solution-links`](#get-update-solution-links)
   - [GET `/get-pcd-videos`](#get-get-pcd-videos)
   - [POST `/update-contest-solution`](#post-update-contest-solution)
   - [GET `/trigger-update-all-contests`](#get-trigger-update-all-contests)
   - [GET `/trigger-update-solutions`](#get-trigger-update-solutions)
   - [GET `/trigger-all`](#get-trigger-all)
